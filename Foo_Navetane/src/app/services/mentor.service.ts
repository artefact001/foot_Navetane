...
getProfil(): Observable<any> {
  const headers = this.createHeaders();
  return this.http.get<any>(`${apiUrl}/modifier/profile-mentor`, { headers })
    .pipe(catchError(this.handleError));
}

updateProfil(profilData: any): Observable<any> {
  const headers = this.createHeaders();
  return this.http.patch<any>(`${apiUrl}/modifier/profile-mentor`, profilData, { headers })
    .pipe(catchError(this.handleError));
}
...
updateProfil(profileData: any): Observable<any> {
  const headers = this.createHeaders();
  return this.http.patch<any>(`${apiUrl}/modifier/profile-mentor`, profileData, { headers })
    .pipe(catchError(this.handleError));
}
}
